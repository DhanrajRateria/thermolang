## ThermoLang TRNG UART capture constraints
...
## USB-UART TX: FT2232H bridge to PC COM port
## Manual shows FTDI TXD wired to FPGA pin C4, RXD to D4 for USB UART :contentReference[oaicite:2]{index=2}
